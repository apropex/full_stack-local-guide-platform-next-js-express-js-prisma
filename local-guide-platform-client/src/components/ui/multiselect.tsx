        ...
        <div className="flex flex-wrap gap-1">
          {selected.map((option) => {
            return (
              <div
                className={cn(
                  "text-foreground relative inline-flex h-7 animate-fadeIn cursor-default items-center rounded-md border bg-background ps-2 pe-7 pl-2 font-medium text-xs transition-all hover:bg-background disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 data-fixed:pe-2 ",
                  badgeClassName,
                )}
